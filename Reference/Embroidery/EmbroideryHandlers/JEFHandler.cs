...
namespace hexreader.EmbroideryHandlers
{
	...
	/// </summary>
	public class JEFHandler:IEmbroideryHandler
	{
	#region JEF
		...
		public Embroidery GetEmbroidery(string filename)
		{
                ...
                int expstart=Convert.ToInt32(b[0]);
                b = bin.Readbytes(24, 1);
                emb.NumberOfColors = Convert.ToInt32(b[0]);
            //Read colors
                ...
                long size = bin.Lenght() - 1 - expstart;
